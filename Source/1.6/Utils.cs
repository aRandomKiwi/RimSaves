    ...
    static class Utils
    {
        ...
        public static void updateMeta(string saveName)
        {
            try
            {
                ...
                if (WorldRendererUtility.WorldRendered && Find.WorldSelector != null && Find.WorldSelector.SelectedTile >= 0)
                {
                    location = Find.WorldGrid.LongLatOf(Find.WorldSelector.SelectedTile);
                }
                else if (WorldRendererUtility.WorldRendered && Find.WorldSelector != null && Find.WorldSelector.NumSelectedObjects > 0)
                {
        ...
        public static readonly string RSRelease = "RimSaves NX rev22";
    }
}
