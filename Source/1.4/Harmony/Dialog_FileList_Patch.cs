        ...
        public class get_InitialSize
        {
            ...
            public static bool Listener(Dialog_FileList __instance, ref Vector2 __result, ref string ___typingName)
            {
                if (__instance is Dialog_IdeoList 
                    || __instance is Dialog_ModList 
                    || __instance is Dialog_ModList_Load 
                    || __instance is Dialog_ModList_Save
                    || __instance is Dialog_XenotypeList
                    || __instance is Dialog_XenotypeList_Load)
                {
                    return true;
                }
        ...
        public class DoWindowContents
        {
                ...
                ref List<SaveFileInfo> ___files, ref float ___bottomAreaHeight, ref Vector2 ___scrollPosition, ref string ___interactButLabel, ref string ___typingName)
            {
                try
                {
                    ...
                    if (__instance is Dialog_ScenarioList || __instance is Dialog_IdeoList || __instance is Dialog_ModList || __instance is Dialog_ModList_Load || __instance is Dialog_ModList_Save || __instance is Dialog_XenotypeList
                    || __instance is Dialog_XenotypeList_Load)
                        return true;
